...
public:
	...
	bool UpdateSentence(ID3D11DeviceContext* pDeviceContext, CFont* pFont, char* lpszText, int nPositionX, int nPositionY, XMFLOAT4 color);

private:
	bool InitilalizeSentence(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, CFont* pFont, char* lpszText, int nPositionX,
